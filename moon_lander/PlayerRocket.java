...
public class PlayerRocket {
    ...
    public void Draw(Graphics2D g2d) {
        ...
        if (Framework.gameState == Framework.GameState.PLAYING2P)
        ...
        // If the rocket is crashed.
            ...
            g2d.drawImage(rocketCrashedImg, rocket1_X, rocket1_Y + rocketImgHeight - rocketCrashedImg.getHeight(), null);
        }
        ...
        // If the rocket is crashed.
            ...
            g2d.drawImage(rocket2pCrashedImg, rocket2_X, rocket2_Y + rocket2pImgHeight - rocket2pCrashedImg.getHeight(), null);
        }
        // If the rocket is still in the space.
        else {
            // If player hold down a W key we draw rocket fire.
